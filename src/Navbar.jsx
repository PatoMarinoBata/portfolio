  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-black shadow-md z-50">
      <div className="flex justify-between items-center px-6 py-4 text-white">
        <div className="font-bold text-lg">Patricio MB</div>
        <div className="space-x-4 text-sm md:text-base">
          ...
          <button onClick={toggleLanguage} className="ml-4 bg-gray-700 px-2 py-1 rounded hover:bg-gray-600 transition">
            {language === "es" ? "EN" : "ES"}
          </button>
        </div>
      </div>
