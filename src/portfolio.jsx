...
export default function Portfolio() {
  ...
  // Carrusel (solo la lógica de cambio de índice)
  const images = [
  ...
  // Validación mínima de textos antes de renderizar
  if (
    !texts?.home?.title ||
    !texts?.home?.subtitle ||
    !texts?.about?.title ||
  ...
  return (
    <div className="snap-y snap-mandatory overflow-y-auto bg-black text-white scroll-smooth pt-20">
      <Navbar />
      ...
      <section
        id="about"
        className="snap-start h-screen flex flex-col md:flex-row items-center justify-center bg-gray-900 px-4 md:px-10"
      >
        {/* Carrusel */}
      ...
      <section
        id="experience"
        className="snap-start min-h-screen bg-gray-950 px-4 md:px-10 py-8"
      >
